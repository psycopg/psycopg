...
cdef class CColumn:
    ...
    def __init__(
        self, pq.PGresult res, object encoding, object types, int index
    ):
    ...
    def type_display(self) -> str:
        ...
        :sql:`date[]`.
        """
        if not self._get_resolved_type():
    ...
    cdef inline object _decode_name(self):
        if self._fname_bytes is not None:
            # Decode using the cached encoding
            # drop bytes to free memory after first use.
    ...
    def display_size(self) -> int | None:
        ...
        if self._get_resolved_type() is None:
            return None

        return self._get_resolved_type().get_display_size(self._fmod)
    ...
    def precision(self) -> int | None:
        ...
        return self._get_resolved_type().get_precision(self._fmod)
    ...
    def scale(self) -> int | None:
        ...
        return self._get_resolved_type().get_scale(self._fmod)
