...
cdef class Int2BinaryDumper(CDumper):
    ...
    cdef Py_ssize_t cdump(self, obj, bytearray rv, Py_ssize_t offset) except -1:
        ...
        cdef int16_t *buf = <int16_t *>CDumper.ensure_size(rv, offset, sizeof(beval))
...
cdef class Int4BinaryDumper(CDumper):
    ...
    cdef Py_ssize_t cdump(self, obj, bytearray rv, Py_ssize_t offset) except -1:
        ...
        cdef int32_t *buf = <int32_t *>CDumper.ensure_size(rv, offset, sizeof(beval))
        memcpy(buf, &beval, sizeof(beval))
        return sizeof(beval)
...
cdef class Int8BinaryDumper(CDumper):
    ...
    cdef Py_ssize_t cdump(self, obj, bytearray rv, Py_ssize_t offset) except -1:
        ...
        cdef int64_t *buf = <int64_t *>CDumper.ensure_size(rv, offset, sizeof(beval))
        memcpy(buf, &beval, sizeof(beval))
        return sizeof(beval)
