...
# Only for release 3.1.7-3.1.8. Not building binary packages because Scaleway
# has no runner available, but psycopg-binary 3.1.6 should work as well
# as there was no change in the interface between psycopg and psycopg_c.
#
# This is getting frustrating, dangerous, stupid. We need to find a way
# out of Scaleway.
version = "3.1.8"
ext_versions = ">= 3.1.6, <= 3.1.8"
