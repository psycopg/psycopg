...
@pytest.mark.parametrize('conninfo, want, env', [('', [''], None), ('service=foo', ['service=foo'], None), ("host='' user=bar", ["host='' user=bar"], None), ("host=127.0.0.1 user=bar port=''", ["host=127.0.0.1 user=bar port='' hostaddr=127.0.0.1"], None), ('host=127.0.0.1 user=bar', ['host=127.0.0.1 user=bar hostaddr=127.0.0.1'], None), ('host=1.1.1.1,2.2.2.2 user=bar', ['host=1.1.1.1 user=bar hostaddr=1.1.1.1', 'host=2.2.2.2 user=bar hostaddr=2.2.2.2'], None), ('host=1.1.1.1,2.2.2.2 port=5432', ['host=1.1.1.1 port=5432 hostaddr=1.1.1.1', 'host=2.2.2.2 port=5432 hostaddr=2.2.2.2'], None), ('host=1.1.1.1,2.2.2.2 port=5432,', ['host=1.1.1.1 port=5432 hostaddr=1.1.1.1', "host=2.2.2.2 port='' hostaddr=2.2.2.2"], None), ('host=1.1.1.1,2.2.2.2 target_session_attrs=prefer-standby', ['host=1.1.1.1 hostaddr=1.1.1.1 target_session_attrs=standby', 'host=2.2.2.2 hostaddr=2.2.2.2 target_session_attrs=standby', 'host=1.1.1.1 hostaddr=1.1.1.1', 'host=2.2.2.2 hostaddr=2.2.2.2'], None), ('port=5432', ['host=1.1.1.1 port=5432 hostaddr=1.1.1.1', 'host=2.2.2.2 port=5432 hostaddr=2.2.2.2'], {'PGHOST': '1.1.1.1,2.2.2.2'}), ('host=foo.com port=5432', ['host=foo.com port=5432'], {'PGHOSTADDR': '1.2.3.4'})])
...
@pytest.mark.parametrize('conninfo, env', [('host=bad1.com,bad2.com', None), ('host=foo.com port=1,2', None), ('host=1.1.1.1,2.2.2.2 port=5432,5433,5434', None), ('host=1.1.1.1,2.2.2.2', {'PGPORT': '1,2,3'})])
