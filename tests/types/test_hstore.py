...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"a": "1", "b": "2"},
            b"\x00\x00\x00\x02\x00\x00\x00\x01a\x00\x00\x00\x011\x00\x00\x00\x01b\x00\x00\x00\x012",
        ),
        (
            {"a": None, "b": "2"},
            b"\x00\x00\x00\x02\x00\x00\x00\x01a\xff\xff\xff\xff\x00\x00\x00\x01b\x00\x00\x00\x012",
        ),
        (
            {"\xe8": "\xe0"},
        ...
        (
            {"a": None, "b": "1" * 300},
            b"\x00\x00\x00\x02\x00\x00\x00\x01a\xff\xff\xff\xff\x00\x00\x00\x01b\x00\x00\x01,"
            + b"1" * 300,
        ),
    ],
)
