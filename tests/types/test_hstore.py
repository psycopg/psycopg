...
@pytest.mark.parametrize(
    ...
    [
        ({}, b'\x00\x00\x00\x00'),
        ({'a': '1', 'b': '2'}, b'\x00\x00\x00\x02\x00\x00\x00\x01a\x00\x00\x00\x011\x00\x00\x00\x01b\x00\x00\x00\x012'),
        ({"a": None, "b": "2"}, b'\x00\x00\x00\x02\x00\x00\x00\x01a\xff\xff\xff\xff\x00\x00\x00\x01b\x00\x00\x00\x012'),
        ({"\xe8": "\xe0"}, b'\x00\x00\x00\x01\x00\x00\x00\x02\xc3\xa8\x00\x00\x00\x02\xc3\xa0'),
        ({"a": None, "b": "1" * 300}, b'\x00\x00\x00\x02\x00\x00\x00\x01a\xff\xff\xff\xff\x00\x00\x00\x01b\x00\x00\x01,' + b'1' * 300),
    ],
)
def test_binary(d, b):
